...
namespace glm {
	namespace detail {
		...
		struct compute_splat<L, float, Q, true> {
			...
			template<>
			GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q> call<0>(vec<L, float, Q> const& a)
			{
				vec<L, float, Q> Result;
			...
			template<>
			GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q> call<1>(vec<L, float, Q> const& a)
			{
				vec<L, float, Q> Result;
			...
			template<>
			GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q> call<2>(vec<L, float, Q> const& a)
			{
				vec<L, float, Q> Result;
			...
			template<>
			GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q> call<3>(vec<L, float, Q> const& a)
			{
				vec<L, float, Q> Result;
